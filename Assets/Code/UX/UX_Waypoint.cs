...
public class UX_Waypoint : MonoBehaviour {
    ...
    [SerializeField]
    private Material opaqueRedMat, semitransRedMat, opaqueYellowMat, semitransYellowMat, opaqueRedPMat,
        semitransRedPMat, opaqueYellowPMat, semitransYellowPMat;
    [SerializeField]
    ...
    public Vector3 Pos { set { mTran.localPosition = value; } }
    ...
    private void UpdatePosToPiece() { if (mPieceTran != null) Pos = mPieceTran.localPosition; }
}
